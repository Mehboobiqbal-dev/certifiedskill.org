...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mediapipe$2f$face_detection$2f$face_detection$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@mediapipe/face_detection/face_detection.js [client] (ecmascript)");
(()=>{
    const e = new Error("Cannot find module '@mediapipe/camera_utils'");
...
function AntiCheating({ onCheatingDetected }) {
    ...
    const [isCheating, setIsCheating] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(false);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AntiCheating.useEffect": ()=>{
            if (!videoRef.current) return;
            // Initialize Face Detection
            const faceDetection = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mediapipe$2f$face_detection$2f$face_detection$2e$js__$5b$client$5d$__$28$ecmascript$29$__["FaceDetection"]({
                locateFile: {
                    "AntiCheating.useEffect": (file)=>`https://cdn.jsdelivr.net/npm/@mediapipe/face_detection/${file}`
                }["AntiCheating.useEffect"]
            });
            ...
            faceDetection.onResults({
                "AntiCheating.useEffect": (results)=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        children: [
            ...
            isCheating && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(AntiCheating, "KvB8BajEdlUIbDcUXO/geas3jgg=");
_c = AntiCheating;
var __N_SSP = true;
function Exam({ exam }) {
    _s1();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Exam.useEffect": ()=>{
            ...
            const timer = setInterval({
                "Exam.useEffect.timer": ()=>{
                    setTimeLeft({
                        "Exam.useEffect.timer": (prev)=>{
                            if (prev <= 1) {
                                clearInterval(timer);
            ...
            }["Exam.useEffect.timer"], 1000);
            return ({
                "Exam.useEffect": ()=>clearInterval(timer)
            })["Exam.useEffect"];
        }
    }["Exam.useEffect"], [
        submitted
    ...
    const handleSubmit = async (e)=>{
        ...
        const timeTaken1 = 40 * 60 - timeLeft;
        const resultData = {
            examId: exam._id,
            score: correctCount,
            total,
...
_s1(Exam, "NdrBOfFT8779C+ellJ9JF92rnrk=");
_c1 = Exam;
var _c, _c1;
__turbopack_context__.k.register(_c, "AntiCheating");
__turbopack_context__.k.register(_c1, "Exam");

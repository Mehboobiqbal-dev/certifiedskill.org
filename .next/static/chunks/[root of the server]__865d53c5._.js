...
function Dashboard() {
    ...
    // Fetch certificates once the session is available
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Dashboard.useEffect": ()=>{
            if (status === "authenticated" && session?.user?.email) {
                fetch(`/api/certificates?userEmail=${session.user.email}`, {
                    cache: "no-store"
                }).then({
...
_s(Dashboard, "/UxxMsqxHZSg/4W0k6yoU0xeNmI=", false, function() {
    return [

...
async function handler(req, res) {
    ...
    try {
        const { db } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"])(); // Ensure database connection
...
async function handler(req, res) {
    ...
    try {
        ...
        const { id } = req.query;
        if (req.method === 'GET') {
            const exam = await __TURBOPACK__imported__module__$5b$project$5d2f$pages$2f$models$2f$Exam$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].findById(id);
            if (!exam) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__aef24eb0._.js.map
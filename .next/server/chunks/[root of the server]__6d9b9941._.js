...
async function handler(req, res) {
    ...
    try {
        ...
        const certificateNumber = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$uuid__$5b$external$5d$__$28$uuid$2c$__esm_import$29$__["v4"])();
        ...
        const bgPath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'public', 'certificate-bg.png');
        if (__TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].existsSync(bgPath)) {
        ...
        const customFontPath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'public', 'fonts', 'GreatVibes-Regular.ttf');
        if (__TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].existsSync(customFontPath)) {
            doc.registerFont('CustomFont', customFontPath);
        }
        // Set fill color and font.
        doc.fillColor('#003366');
        doc.font(customFontPath && __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].existsSync(customFontPath) ? 'CustomFont' : 'Helvetica-Bold');
        // Certificate Title
        ...
        doc.moveDown(1.5);
        // Recipient Name
        doc.fontSize(32).text(`This certifies that`, {
            align: 'center'
        });
        doc.moveDown(0.5);
        doc.fontSize(40).text(userName, {
            align: 'center'
        });
        doc.moveDown(1);
        // Exam Information
        doc.fontSize(28).text(`has successfully passed the exam for`, {
            align: 'center'
        });
        doc.moveDown(0.5);
        doc.fontSize(36).text(examName, {
            align: 'center'
        });
        doc.moveDown(1);
        // Certificate Details
        doc.fontSize(20).text(`Issued on: ${new Date().toLocaleDateString()}`, {
            align: 'center'
        });
        doc.moveDown(0.5);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__6d9b9941._.js.map
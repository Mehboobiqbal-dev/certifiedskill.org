...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$api$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/db.js [api] (ecmascript)"); // Corrected import path
...
async function handler(req, res) {
    ...
    try {
        ...
        doc.on('end', async ()=>{
            ...
            // Optionally, generate a QR code linking to a verification page:
            ...
            const client = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"];
            const db = client.db();
        ...
        doc.moveDown();
        doc.fontSize(20).text(`This certifies that ${userName}`, {
            align: 'center'
        });
        doc.moveDown();
        doc.text(`has successfully passed the exam for ${examName}`, {
            align: 'center'
        });
        doc.moveDown();
        ...
        // Optionally, add a QR code image if you have generated one
        doc.end();
    } catch (error) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__b9002038._.js.map
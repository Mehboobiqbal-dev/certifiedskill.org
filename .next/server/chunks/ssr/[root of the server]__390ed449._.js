    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            if (res.ok) {
                ...
                setError(errorMsg);
                __TURBOPACK__imported__module__$5b$externals$5d2f$sonner__$5b$external$5d$__$28$sonner$2c$__esm_import$29$__["toast"].error(errorMsg);
            }
        } catch (err) {
            const errorDetails = err instanceof Error ? err.message : String(err);
            console.error("Sign-up error:", errorDetails, err);
            setError(`Sign-up error: ${errorDetails}`);
            __TURBOPACK__imported__module__$5b$externals$5d2f$sonner__$5b$external$5d$__$28$sonner$2c$__esm_import$29$__["toast"].error(`Sign-up error: ${errorDetails}`);
        } finally{
            setPending(false);
        }
    };
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__390ed449._.js.map
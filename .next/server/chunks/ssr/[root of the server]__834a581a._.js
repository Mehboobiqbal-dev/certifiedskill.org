...
var __TURBOPACK__imported__module__$5b$externals$5d2f$next$2d$auth$2f$react__$5b$external$5d$__$28$next$2d$auth$2f$react$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/next-auth/react [external] (next-auth/react, cjs)");
var __TURBOPACK__imported__module__$5b$externals$5d2f$sonner__$5b$external$5d$__$28$sonner$2c$__esm_import$29$__ = __turbopack_context__.i("[externals]/sonner [external] (sonner, esm_import)"); // Formal toast notifications
...
async function onExamSubmit(resultData) {
    try {
        ...
        if (!resultRes.ok) {
            __TURBOPACK__imported__module__$5b$externals$5d2f$sonner__$5b$external$5d$__$28$sonner$2c$__esm_import$29$__["toast"].error("There was an error submitting your exam results. Please try again later.");
            console.error(resultJson.message);
            return;
        }
        if (resultData.passed) {
            __TURBOPACK__imported__module__$5b$externals$5d2f$sonner__$5b$external$5d$__$28$sonner$2c$__esm_import$29$__["toast"].success("Congratulations! You have passed the exam. Your certificate is being generated.");
            ...
            if (certRes.ok) {
                ...
                __TURBOPACK__imported__module__$5b$externals$5d2f$sonner__$5b$external$5d$__$28$sonner$2c$__esm_import$29$__["toast"].error("An error occurred while generating your certificate. Please try again later.");
                console.error(certJson.message);
            }
        } else {
            __TURBOPACK__imported__module__$5b$externals$5d2f$sonner__$5b$external$5d$__$28$sonner$2c$__esm_import$29$__["toast"].error("Regretfully, you did not pass the exam. Kindly review your responses and consider retaking the exam.");
        }
    } catch (error) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__834a581a._.js.map
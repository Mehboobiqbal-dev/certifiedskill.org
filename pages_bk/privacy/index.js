...
export default function PrivacyPolicy() {
  return (
    <div className="min-h-screen bg-gray-50">
      <Head>
        <title>Privacy Policy - CertifiedSkill.org</title>
      </Head>
        ...
        <section className="mt-12 space-y-8">
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <p className="mt-2 text-gray-600">
              Welcome to CertifiedSkill.org ("we", "us", "our"). Your privacy is extremely important to us. This Privacy Policy describes how we collect, use, and protect your information when you access our website and services.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <p className="mt-2 text-gray-600">
              ...
              <a href="mailto:privacy@CertifiedSkill.org.com" className="text-blue-600 hover:underline ml-1">
                privacy@CertifiedSkill.org.com
              </a>.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <p className="mt-2 text-gray-600">
              <strong>Email:</strong>{" "}
              <a href="mailto:privacy@CertifiedSkill.org.com" className="text-blue-600 hover:underline">
                privacy@CertifiedSkill.org.com
              </a>
            </p>

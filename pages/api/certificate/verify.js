...
export default async function handler(req, res) {
  ...
  try {
    ...
    doc.font('Helvetica')
      .fontSize(14)
      .text('This is an authentic certificate digitally issued by GetCertified.', { align: 'center' });
    doc.text('Visit GetCertified.com to verify its authenticity.', { align: 'center' });

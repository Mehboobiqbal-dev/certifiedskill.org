        ...
        <main className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          <section className="text-center">
            ...
            <p className="mt-4 text-lg text-gray-600">
              CertifiedSkill.org is a non-profit organization dedicated to recognizing and rewarding talent.
              We offer free certifications and certification free exams that help you showcase your skills
